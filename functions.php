...
if (!function_exists('cocobasic_theme_setup')) {
    ...
    function cocobasic_theme_setup() {
        ...
        load_theme_textdomain('pekko-wp', $lang_dir);
...
if (!function_exists('cocobasic_google_fonts_url')) {
    ...
    function cocobasic_google_fonts_url() {
        ...
        if ('off' !== _x('on', 'Google font: on or off', 'pekko-wp')) {
            $font_url = add_query_arg('family', urlencode('Work Sans:400,500,700|Unna:400,700'), "//fonts.googleapis.com/css");
        }
        return $font_url;
    }
...
if (!function_exists('cocobasic_load_scripts_and_style')) {
    ...
    function cocobasic_load_scripts_and_style() {
        ...
        wp_enqueue_style('pekko-google-fonts', cocobasic_google_fonts_url(), array(), '1.0.0');
...
//register and load styles which is used on every pages       
        wp_enqueue_style('pekko-clear-style', $base_theme_url . '/css/clear.css');
        wp_enqueue_style('pekko-common-style', $base_theme_url . '/css/common.css');
        wp_enqueue_style('sm-cleen', $base_theme_url . '/css/sm-clean.css');
        wp_enqueue_style('pekko-main-theme-style', $base_theme_url . '/style.css');
...
//JavaScript
        ...
        wp_enqueue_script('pekko-main', $base_theme_url . '/js/main.js', array('jquery'), false, true);
        ...
        wp_localize_script('pekko-main', 'ajax_var', array(
        ...
        wp_add_inline_style('pekko-main', $inlineHeaderCss->cocobasic_theme_customized_style());
    }
...
if (!function_exists('cocobasic_search_form')) {
	...
	<label>		
	<input autocomplete="off" type="search" class="search-field" placeholder="' . esc_attr__('Search', 'pekko-wp') . '" value="" name="s" title="' . esc_attr__('Search for:', 'pekko-wp') . '" /> 
</label>    
</form>';
...
if (!function_exists('cocobasic_wp_register_required_plugins')) {
    ...
    function cocobasic_wp_register_required_plugins() {
        ...
        $plugins = array(
            array(
                'name' => esc_html('CocoBasic - Pekko WP'),
            ...
            array(
                'name' => esc_html('CocoBasic - Pekko Elementor Widgets'),
...
if (!function_exists('cocobasic_wp_widgets_init')) {
    ...
    function cocobasic_wp_widgets_init() {
        register_sidebar(array(
            'name' => esc_html__('Menu Sidebar', 'pekko-wp'),
            'id' => 'menu-sidebar',
            'description' => esc_html__('Widgets in this area will be shown in sidebar menu on all pages and posts', 'pekko-wp'),
...
function cocobasic_custom_footer() {
    $query = new WP_Query(array(
        ...
        'page_id' => get_theme_mod('cocobasic_select_footer')
    ));
